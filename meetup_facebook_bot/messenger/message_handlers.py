...
def handle_no_ask_question_url_postback(messaging_event, access_token, db_session):
    sender_id = messaging_event['sender']['id']
    logger.debug('handling message with sender_id:%s' % sender_id)
